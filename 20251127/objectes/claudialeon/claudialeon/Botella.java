...
//contructor vuit que fa botellas con estas caracteristiques
    ...
    //new per a crear un obj nou cotxe cotxet=new cotxe;
    //contructor sempre es public y no retorna res class cotxe(){}
    //els atributs son private, amb les funcions getters (retornas atribut),
    //GEtter get atribut
    //si l'atribut es boolean en vez de gettapon, es istapon
    ...
    //setter es de SET, de marcar/configurar

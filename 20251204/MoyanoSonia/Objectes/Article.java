...
public void setIVA(int IVA) {
        if (IVA == 21 || IVA ==10 || IVA ==4) {
            ...
            System.out.println("Indiqueu el tipus d'IVA correcte:");
            System.out.println("21 - Tipus d'IVA general");
            System.out.println("10 - Tipus d'IVA reduït");
            System.out.println("4  - Tipus d'IVA superreduït");
        }
    }

...
public class CRUD 
{
    ...
    private static void añadirLuchadorPosicion (List<Luchador> mundial) 
    {
        Scanner sc = new Scanner(System.in);
         try 
         {
            System.out.print("Introduce el nombre del luchador: ");
            String nombre = sc.nextLine();
            
            System.out.print("Introduce el numero de licencia: ");
            int numLicencia = sc.nextInt();
            sc.nextLine();

            System.out.print("Introduce el peso del luchador");
            int peso = sc.nextInt();
            sc.nextLine();
